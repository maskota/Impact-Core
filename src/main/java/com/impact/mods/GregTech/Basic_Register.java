...
public class Basic_Register {
    ...
    private void registerMachines() {
		...
		*/
        ...
        /*todo поменять нейминг */Communication_Hatch_Receiver.set(new GTMTE_ComputerRack(ID2++, "impact.machine.communicationhatch.receiver", "Communication Receiver Hatch").getStackForm(1L));
