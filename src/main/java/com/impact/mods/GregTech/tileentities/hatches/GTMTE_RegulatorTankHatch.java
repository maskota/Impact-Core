...
public class GTMTE_RegulatorTankHatch extends GT_MetaTileEntity_Hatch {

    private String lockedFluidName = null;
    private EntityPlayer playerThatLockedfluid = null;
    public byte mMode = 0;
    public int mCapacityCurrent = 10000;

    public GTMTE_RegulatorTankHatch(int aID, String aName, String aNameRegional, int aTier) {
        super(aID, aName, aNameRegional, aTier, 3, new String[]{
                "Fluid Output for Multiblocks",
                "Adjustable Capacity from Tank Capacity",
    ...
    public GTMTE_RegulatorTankHatch(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GTMTE_RegulatorTankHatch(mName, mTier, mDescriptionArray, mTextures);
    }
    ...
    public void saveNBTData(NBTTagCompound aNBT) {
        ...
        aNBT.setInteger("mCapacityCurrent", mCapacityCurrent);
    }
    ...
    public void loadNBTData(NBTTagCompound aNBT) {
        ...
        mCapacityCurrent = aNBT.getInteger("mCapacityCurrent");
    }
    ...
    public int getCapacity() {
        return mCapacityCurrent;
    }

    public void setCapacity(int Capacity) {
        mCapacityCurrent = Capacity;
    }
