...
public class GT_GUIContainer_Reactor_Rod extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRendererObj.drawString((((GT_Container_Reactor_Rod) mContainer).getPosRod() * 10) + "%", 109, 41, 4210752);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        double tScale = (double) ((GT_Container_Reactor_Rod) mContainer).getPosRod() / 10D;
