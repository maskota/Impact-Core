...
public class GT_GUIContainerMT_Machine extends GT_GUIContainer {
    ...
    public void getTooltip(int mouseX, int mouseY, int startX, int startY, int hight, int weight, List<String> strings) {
  ...
  public void getTooltip(int mouseX, int mouseY, int startX, int startY, int hight, int weight, String[] strings) {
      this.getTooltip(mouseX, mouseY, startX, startY, hight, weight, getTooltipText(strings));
  }
